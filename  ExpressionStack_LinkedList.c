...
//알고리즘 설명 : 0 ~ 9까지의 정수만을 포함하는 중위표기식을 입력받아 후위표기식으로 바꾼 후 계산을 수행한다. 연결리스트로 스택을 구현한다.
...
int main(void)
{
    ...
    scanf("%s", f_infix); // 엔터 입력할 때까지 입력 받기
    // printf("%s", f_infix);
